...
public class SupplierIntegrationRealTimePricingOrdering_Steps {
	...
	public void theKitchenManagerWantsToCheckIngredientPrices() {
		mySystem.createKitchenManager("KitchenManager", "password");
		mySystem.loginKitchenManager("KitchenManager", "password");
		// mySystem.loginKitchenManager("KitchenManager2", "wrongpassword");
		assertTrue("Kitchen manager should be logged in", mySystem.kitchenManagerIsLoggedIn("KitchenManager"));
	...
	public void anIngredientSStockLevelIsCriticallyLow() {
		mySystem.setStockLevel("Tomato", 5);
	...
	public void theSystemDetectsTheLowStockLevel() {
		mySystem.setStockLevel("Tomato", 10);
		mySystem.checkStockLevels();
		assertTrue("System detect low stock levels", mySystem.isLowStockDetected("Tomato", 10));
	}
