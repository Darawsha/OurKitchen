...
public class BillingSystem_Steps {
    ...
    public void theBillShouldContainTheCustomerSNameOrderNumberDateOfOrderCostOrderDetailsAndPaymentMethod(
            String customerName, String orderNumber, String orderDate, String cost, String orderDetails, String paymentMethod) {
    ...
    public void theBillShouldBeAddedToTheCustomerSAccountOrderHistory() {
        ...
        assertTrue("Bill should be in customer's order history", mySystem.customerHasBillInHistory(mySystem.getBillDetails()));
    }
